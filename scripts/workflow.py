...
def print_benchmark_hub_edit_hints(instance_id: str, paths: list[str]) -> None:
    """Instructions for editing project/ in the benchmark hub."""
    proj = project_root()
    print(format_active_task_status())
    print("Edit the project (evaluated by GSO harness in Docker):")
...
def sync_optimization_guide(instance_id: str, expert_dir: Path) -> None:
    """Copy benchmarks/<slug>/OPTIMIZATION.md into eval expert/ when present."""
